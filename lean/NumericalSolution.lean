...
-- The alias types retain named hypothesis binders verbatim from the specification.
set_option linter.unusedVariables false

/-! Numerical solutions corresponding to NumericalChallenge. The Challenge
is not imported, directly or indirectly. These aliases expose supporting
theorems only; they do not assert the main graph result. -/
...
theorem exists_avoiding_of_sum_card_lt : ∀ {ι Ω : Type*} [DecidableEq Ω]
  ...
  @Crown.Counting.exists_avoiding_of_sum_card_lt
...
theorem exists_avoiding_of_bounds : ∀ {ι Ω : Type*} [DecidableEq Ω]
    ...
    ∃ ω ∈ samples, ∀ i ∈ indices, ω ∉ bad i :=
  @Crown.Counting.exists_avoiding_of_bounds
...
theorem exists_avoiding_of_uniform_bound : ∀ {ι Ω : Type*} [DecidableEq Ω]
    ...
    ∃ ω ∈ samples, ∀ i ∈ indices, ω ∉ bad i :=
  @Crown.Counting.exists_avoiding_of_uniform_bound
...
theorem exists_good_orientation : ∀ (k : ℕ) (hk : 8 ≤ k)
  ...
  @Crown.Counting.exists_good_orientation
